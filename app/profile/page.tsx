      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          <div className="w-full flex justify-center">
            <Avatar name={username} colors={["#152e57", "#11235d", "#660e44", "#aa0600", "#e06800"]} variant="beam"  size={128}/>
          </div>
          ...
          <Button variant="outline" className="w-full" onClick={handleForgotPassword}>request password change</Button>
