        ...
        <Card className="w-full max-w-md">
            <CardContent className="pt-6">
                <div className="mb-4">
                    ...
                    <Progress
                        value={
                            initialTimeToAnswer > 0
                                ? (timeLeft / initialTimeToAnswer) * 100
                                : 0
                        }
                    />
                </div>
                  ...
                  question.questionType === 'TRUE_FALSE' ? (
                    ...
                    >
                        {question.answers.map((answer) => (
                            <div
                                key={answer.id}
                                className="flex items-center space-x-2 p-3 border rounded-md has-[:disabled]:opacity-70 has-[:disabled]:cursor-not-allowed"
                            >
                                <RadioGroupItem
                ...
                <Button
                    ...
                    disabled={
                        (question.questionType === 'OPEN_ENDED'
                            ? !openAnswer.trim()
                            : selectedAnswers.length === 0) || submittedAnswer
                    }
                >
