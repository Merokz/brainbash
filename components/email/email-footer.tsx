...
export const Footer: React.FC = () => (
  <div style={{ marginTop: "30px", borderTop: `1px solid ${theme.colors.border}`, paddingTop: "10px" }}>
    ...
    <Text style={{ fontSize: "12px", color: theme.colors.muted, textAlign: "center" }}>
      <a href={theme.brand.url} style={{ color: theme.colors.primary, textDecoration: "none" }}>
